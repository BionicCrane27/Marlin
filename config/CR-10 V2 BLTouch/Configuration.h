...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //CR-10 V2 (Pulled from Factory Configuration.h)
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 5, 25 } //CR-10 V2 Factory Default
 ...
 *
 */
#define Z_MIN_PROBE_PIN 19 // RAMPS_CREALITY uses Z_MAX as probe pin
