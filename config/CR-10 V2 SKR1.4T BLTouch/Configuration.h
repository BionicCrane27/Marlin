...
#define STRING_CONFIG_H_AUTHOR "(rigg77, CR-10 V2 SKR1.4T Mod)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CR-10 V2 SKR1.4T"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.08, 80.08, 397, 95 }
...
#define FLASH_EEPROM_EMULATION    //Store EEPROM on SD Card (activate if EEPROM Flash will not initialize)
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), (Y_MAX_POS - 10), 20 } //From CR-10 Factory Firmware
